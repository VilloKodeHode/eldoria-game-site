  ...
  return (
    <>
      ...
      >
        ...
        <ItemRecipes playerInventory={playerInventory} itemType="potions" />
        <ItemRecipes playerInventory={playerInventory} itemType="armour" />
        <ItemRecipes playerInventory={playerInventory} itemType="weapons" />
      </div>
    </>
  );
};
