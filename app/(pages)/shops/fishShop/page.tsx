// app/(pages)/shops/fishShop/page.tsx

"use client";

export default function FishShopPage() {
  return (
    <div className="flex items-center justify-center h-screen text-lunar-pearl text-4xl">
      🐟 The Fish Shop is opening soon...
    </div>
  );
}
...
// import shopData from "./data/fishShopInfo.json";
...
//               width={300}
//               height={300}
//               src={craftedItem?.src ?? "/images/fishShop/background/empty-dish.png"}
//               alt={
